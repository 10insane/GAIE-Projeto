...
def PaginaCriarRegistoAdmin(page: ft.Page):
    """
    Página para criar um novo registo no sistema SPO (Versão Admin).
    """
    ...
    return ft.Container(
        content=ft.Column([
            ...
            ft.Container(content=ft.Row([
                ft.IconButton(icon=ft.Icons.ARROW_BACK, icon_color=CORES["primaria"], icon_size=24, on_click=lambda e: page.go("/TelaPrincipalAdmin"), tooltip="Voltar", bgcolor=CORES["fundo"], style=ft.ButtonStyle(shape=ft.CircleBorder())),
